...
pip install "recusal==0.5.10"   # the plugin is version-bound; fails CLOSED without it
...
- uses: actions/setup-python@v6
  with:
    python-version: "3.12"
- uses: philpaz/recusal@v0.5.10   # or pin an immutable commit SHA for stronger provenance
  with:
