...
- **Two postures, two claims.** A substring **deny-list** is a baseline: it stops the
  ...
  Protect the hook's own config in either posture so an agent cannot disable it.
