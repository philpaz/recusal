...
This file is both a demo and a real policy:
    ...
    #   { "type": "command",
    #     "command": "for p in python3 python py; do \"$p\" -c 'import sys; sys.version_info >= (3, 9) or sys.exit(1); import recusal' 2>/dev/null && { \"$p\" .../examples/allowlist_gate.py --hook; rc=$?; [ \"$rc\" = 0 ] || exit 2; exit 0; }; done; exit 2" }
